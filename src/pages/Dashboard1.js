...
//  import { BiSearch, BiBell, BiUserCricle } from 'react-icons/bi';
...
// const Dashboard = () => {
//   const { user } = useAuth();
//   const { dashboardMetrics, monthlyDate, fetchDashboardMetrics } = useData();
...
//   useEffect(() => {
//     fetchDashboardMetrics(location)
//       .then(response => response.json())
//       .then(data => {
//         setCargoCount(data.cargoCount);
//         setClientCount(data.clientCount);
//       });
//   }, [location]);  if (!dashboardMetrics) {
...
//         <BarChart title="Monthly Shipments" data={monthlyData} xDataKey="month" bars={[{ dataKey: 'air', fill: '#3b82f6', name: 'Air Shipments' }, { dataKey: 'sea', fill: '#10b981', name: 'Sea Shipments' }]} />
//         <LineChart title="Monthly Revenue" data={monthlyData} xDataKey="month" lines={[{ dataKey: 'revenue', stroke: '#3b82f6', name: 'Revenue ($)' }]} />
//       </div>

//       <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
//         <PieChart title="Transport Mode Distribution" data={transportModeData} dataKey="value" nameKey="name" colors={['#3b82f6','#10b981']}/>
//         <LineChart title="Client Acquisition" data={monthlyData} xDataKey="month" lines={[{ dataKey: 'clients', stroke: '#3b82f6', name: 'New Clients' }, { dataKey: 'repeatingClients', stroke: '#10b981', name: 'Repeating Clients' }]} />
//       </div>
//     </div>
//   );
// };
